...
**⚠️ USE INDEPENDENT REVIEW WHEN AVAILABLE** — even for 2-3 slides. If Jimu sub-agents are available, use an independent reviewer; otherwise do a separate review pass with fresh context.
