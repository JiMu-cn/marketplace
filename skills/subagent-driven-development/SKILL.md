...
license: 
category: workflow
tags: Superpowers, 子代理, 协作开发, 任务拆分
...
digraph process {
    ...
    subgraph cluster_per_task {
        ...
        "mark task complete in the current todo tracker" [shape=box];
    }

    "Read plan, extract all tasks with full text, note context, create a tracked todo list" [shape=box];
    "More tasks remain?" [shape=diamond];
    "Dispatch final code reviewer subagent for entire implementation" [shape=box];
    "Use superpowers:finishing-a-development-branch" [shape=box style=filled fillcolor=lightgreen];

    "Read plan, extract all tasks with full text, note context, create a tracked todo list" -> "Dispatch implementer subagent (./implementer-prompt.md)";
    ...
    "Code quality reviewer subagent approves?" -> "mark task complete in the current todo tracker" [label="yes"];
    "mark task complete in the current todo tracker" -> "More tasks remain?";
...
[Create tracked todo list with all tasks]
