...
description: |
  Use when starting a conversation that needs skill discovery - establishes how to find and activate relevant skills through the current Jimu skill mechanism before responding
author: obra
license: 
category: workflow
tags: Superpowers, 技能使用, 工作流, 元技能
...
digraph skill_flow {
    ...
    "Create tracked todo per item" [shape=box];
    ...
    "Has checklist?" -> "Create tracked todo per item" [label="yes"];
    "Has checklist?" -> "Follow skill exactly" [label="no"];
    "Create tracked todo per item" -> "Follow skill exactly";
}
```
