...
# Remove or archive the standby data directory only after backup and explicit confirmation.
# Do not run destructive deletion commands automatically.
...
# Clear or replace the data directory only after backup and explicit confirmation.
# Do not run destructive deletion commands automatically.
