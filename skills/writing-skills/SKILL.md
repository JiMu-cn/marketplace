...
license: 
category: workflow
tags: Superpowers, Skill创建, 技能写作, 元技能
...
**Personal skills live in the host platform's skill directory. In Jimu, use `~/.jimu/skills/` for local skills or the Jimu resource repository format for marketplace skills.** 
...
**IMPORTANT: Use the current Jimu todo tracker to create todos for EACH checklist item below.**
