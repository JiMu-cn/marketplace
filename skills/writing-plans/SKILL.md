...
license: 
category: planning
tags: Superpowers, 计划文档, 执行拆解, 验证标准
...
> **For agentic workers:** REQUIRED SUB-SKILL: Use the Jimu-adapted subagent-driven-development workflow when available, or the executing-plans workflow to implement this plan task-by-task. Steps use checkbox (`- [ ]`) syntax for tracking.
...
- **REQUIRED SUB-SKILL:** Use the Jimu-adapted subagent-driven-development workflow
